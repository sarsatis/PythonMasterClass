# Here *args unpacks the tuple or we can pass a tuple to *args parameter
numbers = (0, 1, 2, 3, 4, 5)
...
###################################################################################################################
# In the below example we are passing effects are *args so that we can pass multiple effects
