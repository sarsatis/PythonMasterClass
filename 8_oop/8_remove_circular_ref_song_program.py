# In the below program Song class and Album class contains reference of artist object which creates a circular
# Dependency we will be removing circular dependency
class Song:
